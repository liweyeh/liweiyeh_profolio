...
const Skills = () => {
    ...
    const isInView = (offset, ref) => {
        if (ref) {
            ...
            const viewport =
                window.innerHeight -
                ref.getBoundingClientRect().height / offset;
            if (top <= viewport) {
                return true;
            }
        }
